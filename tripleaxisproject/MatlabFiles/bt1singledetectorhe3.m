...
files={'C:\ZnMn2o4\OP23p002.bt1';'C:\ZnMn2o4\OP23p003.bt1';'C:\ZnMn2o4\OP23p004.bt1';'C:\ZnMn2o4\OP23p005.bt1';'C:\ZnMn2o4\OP23p006.bt1';'C:\ZnMn2o4\OP23p007.bt1'};
...
start=1;
finish=length(currtemp);

start=1; finish=125;
trange=find(currtemp>10 & currtemp<90);
bak=mean(currdetector(find(currtemp>75)))
high=mean(currdetector(find(currtemp>10&currtemp<20)))

%opdata=[currtemp(start:finish);currdetector(start:finish);sqrt(currdetector(start:finish))]';
opdata=[currtemp(trange);currdetector(trange);sqrt(currdetector(trange))]';

%%plot(opdata(:,1),opdata(:,))
