...
class Experiments(Base):
    ...
    instrument_list=relation('Instruments',backref=backref('experiments'))
    people_list=relation('Person',secondary=people_experiments, backref='experiments')
...
class Person(Base):
    ...
    organization_list=relation('Organization',secondary=people_organizations, backref='people')
    experiment_list=relation("Experiments",secondary=people_experiments, backref='people')
...
class Instruments(Base):
    ...
    experiment_list=relation('Experiments',backref=backref('instruments',
...
class Samples(Base):
    ...
    can_list=relation('Cans',backref=backref('samples'))
    photos_list=relation('Photos',backref=backref('samples',
                                           cascade='all,delete-orphan'))
    #instrument=relation('Instruments',backref=backref('samples'))  
    experiments_list=relation('Experiments',backref=backref('samples',
                                                     cascade='all,delete-orphan'))
...
class Photos(Base):
    ...
    experiment_list=relation('Experiments',backref=backref('photos'))#,
                        #cascade='all,delete-orphan'))
...
class Cans(Base):
    ...
    sample_id=Column(Integer, ForeignKey('samples.id'))
    sample_list=relation('Samples',backref=backref('cans'))#,
    #def __init__(self):
        #pass
