function ZBRENTp, x1, x2, FUNC_NAME=func_name,    $
                         MAX_ITERATIONS=maxit, TOLERANCE=TOL,temp=temp,myp=myp
;+
; NAME:
;     ZBRENT
; PURPOSE:
...
;-
        ...
        fa = call_function( func_name, xa,temp,myp )
        fb = call_function( func_name, xb,temp,myp )
        fc = fb
